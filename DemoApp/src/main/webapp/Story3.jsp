...
<h1>Price List</h1>
<%
    org.apache.commons.dbcp2.BasicDataSource dataSource = blog.pwned.sqli.samples.ConnectionPoolUtil.getDataSourceStory3();
    java.sql.Connection connection = dataSource.getConnection();
    try {
        if(request.getParameter("q") != null && request.getParameter("q").length() > 0) {
            String sqlQurty = "SELECT * FROM APP789_PRODUCT";
            sqlQurty = sqlQurty + " where APP789_PRODUCT_NAME='" + request.getParameter("q") + "'";
...
%>
<form action="Story3.jsp" method="get">
